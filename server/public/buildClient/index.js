...
function render(App) {
  if (true) {
    react_loadable__WEBPACK_IMPORTED_MODULE_2___default.a.preloadReady().then(() => react_dom__WEBPACK_IMPORTED_MODULE_1__["hydrate"](react__WEBPACK_IMPORTED_MODULE_0__["createElement"](App, null), document.getElementById('root')));
  } else {}
}
